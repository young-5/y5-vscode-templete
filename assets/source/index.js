...
(() => {
  ...
  const taoists = document.querySelector("#taoists");
  state.map((n) => {
  ...
  taoists?.addEventListener("click", openTaoistsPage);
  function openTaoistsPage() {
    vscode.postMessage({ type: "openTaoistsPage" });
  }
